...
// const projectApi = "https://projectapi.gerasim.in/api/Complaint"
const free_project_api = "https://api.freeprojectapi.com/api/UserApp"
...
export const ApiUrls = {
  register: `${free_project_api}/CreateNewUser`,
